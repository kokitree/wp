...
$disable_related_posts = get_theme_mod( 'miyazaki_disable_related_posts' );
...
if ( is_single() && ! $disable_related_posts ) :
	...
	if ( $related_posts ) : ?>
		...
		<div class="related-posts section-inner">
			...
			<h6 class="related-posts-title title-with-arrow">
				<span class="text"><?php _e( 'Related Reviews', 'miyazaki' ); ?></span>
